...
VIEWER_UI="src/viewer/ui/theme.cpp src/viewer/ui/icons.cpp src/viewer/ui/commands.cpp src/viewer/ui/tooltip.cpp src/viewer/ui/popup_menu.cpp src/viewer/ui/ribbon.cpp src/viewer/ui/status_bar.cpp src/viewer/ui/side_panel.cpp src/viewer/ui/start_page.cpp src/viewer/ui/view_cube.cpp"
