...
g++ %FLAGS% -shared -o dist\StepShellExt.dll src\shellext\dllmain.cpp src\shellext\thumbnail_provider.cpp src\shellext\preview_handler.cpp src\viewer\scene_view.cpp src\viewer\image_view.cpp src\viewer\text_overlay.cpp src\viewer\markup_tools.cpp %ENGINE% src\shellext\shellext.def %STATIC% -lole32 -loleaut32 -luuid -lshlwapi -lshell32 -ladvapi32 -lgdi32 -lgdiplus
